        ...
        <table class="table table-bordered" id="linesTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input name="lines[{{$i}}][debit]" type="number" step="0.01" class="form-control debit-input" value="0"></td>
                    <td><input name="lines[{{$i}}][credit]" type="number" step="0.01" class="form-control credit-input" value="0"></td>
