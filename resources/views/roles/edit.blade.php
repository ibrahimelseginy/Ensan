...
<div class="container-fluid">
    ...
    <div class="page-header mb-4">
        <div>
            ...
            <p class="text-muted mb-0">تحديث بيانات الدور والصلاحيات المرتبطة به</p>
        </div>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-3">
                            ...
                            <input name="name" class="form-control" value="{{ $role->name }}" required placeholder="مثال: مدير النظام">
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">المعرف (Key)</label>
                            <input name="key" class="form-control font-monospace" value="{{ $role->key }}" required placeholder="مثال: admin">
                            <div class="form-text">يجب أن يكون فريداً وباللغة الإنجليزية.</div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold">الوصف</label>
                            <textarea name="description" class="form-control" rows="4" placeholder="وصف مختصر لمهام هذا الدور...">{{ $role->description }}</textarea>
                        </div>
                        <div class="d-grid">
                                    ...
                                    <div class="border rounded bg-body-tertiary h-100">
                                        <div class="p-3 border-bottom d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="form-check form-switch mb-0">
                                                <input class="form-check-input group-toggle" type="checkbox" data-group="group-{{ $loop->index }}">
                                            </div>
                                        </div>
                                        <div class="p-3">
