    ...
    <div class="container-fluid p-0">
        ...
        <div class="page-header mb-4">
            <div>
                ...
                <p class="text-muted small mt-1 mb-0">قم بتعيين مهمة جديدة لموظف وتحديد تفاصيلها.</p>
            </div>
                        ...
                        <form method="POST" action="{{ route('employee-tasks.store') }}">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="title" class="form-control form-control-lg fs-6" required
                                        placeholder="مثال: إعداد تقرير شهري، صيانة..."
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="description" class="form-control" rows="4"
                                        placeholder="اكتب تفاصيل المهمة هنا...">{{ request('subject_beneficiary_id') ? ('مهمة مرتبطة بالمستفيد رقم ' . request('subject_beneficiary_id')) : '' }}</textarea>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="assigned_to" class="form-select form-select-lg fs-6">
                                        ...
                                        @foreach($users as $u)
                                            <option value="{{ $u->id }}"
                                                @selected((string) request('assigned_to') === (string) $u->id)>{{ $u->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <select name="campaign_id" class="form-select form-select-lg fs-6" id="relCampaign"
                                        ...
                                        @foreach($campaigns as $c)
                                            <option value="{{ $c->id }}">{{ $c->name }}
                                                {{ $c->season_year ? '(' . $c->season_year . ')' : '' }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-8 rel rel-guest_house" style="display:none">
                                    ...
                                    <select name="guest_house_id" class="form-select form-select-lg fs-6" id="relGuestHouse"
                                        disabled>
                                        <option value="">—</option>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="evaluation_notes" class="form-control" rows="2"
                                            placeholder="أضف ملاحظات حول أداء الموظف في هذه المهمة..."></textarea>
                                    </div>
                                </div>
                            </div>
