    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="page-header">
                <h4 class="mb-0">تعديل بيانات المورد</h4>
                    ...
                    <form action="{{ route('suppliers.update', $supplier) }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="merchant_name" class="form-control" value="{{ $supplier->merchant_name }}">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="source_name" class="form-control" value="{{ $supplier->source_name }}">
                            </div>
                            <div class="col-md-12">
