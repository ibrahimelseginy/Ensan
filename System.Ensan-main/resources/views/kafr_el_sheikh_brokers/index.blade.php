...
@section('title', 'سماسرة كفر الشيخ')
@section('styles')
<style>
...
<div class="row align-items-center mb-4">
    <div class="col-md-6">
        <h3 class="fw-bold mb-0">
            <i class="bi bi-pin-map text-primary me-2"></i>سماسرة كفر الشيخ
        </h3>
        <p class="text-muted small mb-0 mt-1">قاعدة بيانات سماسرة كفر الشيخ</p>
    </div>
...
<div class="card border-0 shadow-sm">
                    ...
                    @forelse($brokers as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form method="POST" action="{{ route('kafr-el-sheikh-brokers.destroy', $item) }}" class="d-inline"
    ...
    @if(method_exists($brokers, 'hasPages') && $brokers->hasPages())
...
<div class="modal fade" id="createModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg border-0" style="background-color: #1a1a1a !important; opacity: 1 !important;">
            <form method="POST" action="{{ route('kafr-el-sheikh-brokers.store') }}">
                @csrf
                <div class="modal-header bg-primary text-white border-0" style="background-color: #0066ff !important;">
                    <h5 class="modal-title fw-bold">إضافة سمسار جديد</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body bg-body p-4" style="background-color: #1a1a1a !important; color: white !important;">
                    <div class="mb-3">
                        <label class="form-label">اسم السمسار <span class="text-danger">*</span></label>
                    ...
                    <div class="mb-3">
                        <label class="form-label">المنطقة المخصصة</label>
                        <input type="text" name="area" class="form-control" style="background-color: #121212 !important; border: 1px solid #333 !important; color: white !important;">
                    </div>
                    <div class="mb-3">
                ...
                <div class="modal-footer border-0 bg-body" style="background-color: #1a1a1a !important;">
...
<div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg border-0" style="background-color: var(--bs-body-bg) !important; opacity: 1 !important;">
            <form method="POST" action="{{ route('kafr-el-sheikh-brokers.update', $item) }}">
                @csrf
                @method('PUT')
                <div class="modal-header bg-primary text-white border-0" style="background-color: #0066ff !important;">
                ...
                <div class="modal-body bg-body p-4" style="background-color: #1a1a1a !important; color: white !important;">
                    ...
                    <div class="mb-3">
                        <label class="form-label">المنطقة المخصصة</label>
                        <input type="text" name="area" class="form-control" value="{{ $item->area }}" style="background-color: #121212 !important; border: 1px solid #333 !important; color: white !important;">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">رقم التليفون</label>
