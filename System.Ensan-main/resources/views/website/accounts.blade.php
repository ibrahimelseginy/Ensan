...
<style>
    ...
    .modal-backdrop.show {
      ...
      body:not(.theme-dark) .card-premium-dark,
      ...
      body:not(.theme-dark) .saas-modal-content,
      ...
      body:not(.theme-dark) .saas-form-control,
      body:not(.theme-dark) .saas-input-group,
      ...
      body:not(.theme-dark) .saas-input-group:focus-within {
          border-color: var(--ws-primary) !important;
          background: #fff !important;
          box-shadow: 0 0 0 4px rgba(var(--ws-primary-rgb), 0.1) !important;
      }
      ...
      body:not(.theme-dark) .saas-label,
      ...
      body:not(.theme-dark) .table-dark-custom th,
      ...
      body:not(.theme-dark) .table-dark-custom tbody td,
