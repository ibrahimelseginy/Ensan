...
<style>
    ...
    /* Bulk Action Bar */
    .bulk-action-bar-elite { z-index: 1050; position: fixed; top: 100px; left: 50%; transform: translateX(-50%); }
    .bg-onyx-dark { background: #0f172a; }
...
<script>
    ...
    function submitBulkDelete() {
        ...
        if (confirm(`هل أنت متأكد من حذف ${checkboxes.length} طلبات مختارة؟ لا يمكن التراجع عن هذا الإجراء.`)) {
