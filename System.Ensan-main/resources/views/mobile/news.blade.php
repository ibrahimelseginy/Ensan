...
<div class="modal fade" id="addNews" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <form action="{{ route('mobile.news.store') }}" method="POST" enctype="multipart/form-data" class="modal-content dark-glass-card border-0">
            @csrf
            <div class="modal-header border-0">
                <h5 class="modal-title fw-bold">إضافة خبر جديد للتطبيق (موبايل)</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body p-4">
                <div class="row g-3">
            ...
            <div class="modal-footer border-0">
                <button type="submit" class="btn btn-primary rounded-pill px-5 shadow-sm">نشر الخبر على التطبيق</button>
            </div>
        </form>
    </div>
</div>
